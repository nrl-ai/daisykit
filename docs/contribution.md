...
Coding convention for the code base should be formatted and checked by [clang-format](https://clang.llvm.org/docs/ClangFormat.html). Configuration file `.clang-format` for code formatting can be found [here](https://github.com/open-daisylab/daisykit/blob/master/.clang-format).
...
Create a pull request to <https://github.com/open-daisylab/daisykit>. Visit repository for the setup instructions.
...
Create a pull request to <https://github.com/open-daisylab/daisykit-android>. Visit repository for the setup instructions.

**Next tasks:** Build wrappers for Kotlin, Java and example applications.

## V. Contribute to Daisykit iOS

Create a pull request to <https://github.com/open-daisylab/daisykit-ios>. Visit repository for the setup instructions.
